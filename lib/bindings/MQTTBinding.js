...
function generateTopics(callback) {
    ...
    topics.push(constants.MQTT_SHARE_SUBSCRIPTION_GROUP + '/4jggokgpepnvsb2uv4s40d59ov/motion001/' + constants.MEASURES_SUFIX + '/c');
    topics.push(
        constants.MQTT_SHARE_SUBSCRIPTION_GROUP +
            '/' +
            constants.MQTT_TOPIC_PROTOCOL +
            '/4jggokgpepnvsb2uv4s40d59ov/motion001/' +
            constants.MEASURES_SUFIX +
            '/c'
    );
    topics.push(constants.MQTT_SHARE_SUBSCRIPTION_GROUP + '/4jggokgpepnvsb2uv4s40d59ov/motion001/' + constants.MEASURES_SUFIX);
    topics.push(
        constants.MQTT_SHARE_SUBSCRIPTION_GROUP +
            '/' +
            constants.MQTT_TOPIC_PROTOCOL +
    ...
    topics.push(constants.MQTT_SHARE_SUBSCRIPTION_GROUP + '/4jggokgpepnvsb2uv4s40d59ov/motion001/' + constants.CONFIGURATION_COMMAND_UPDATE);
    topics.push(
        constants.MQTT_SHARE_SUBSCRIPTION_GROUP +
            '/' +
            constants.MQTT_TOPIC_PROTOCOL +
    ...
    topics.push(constants.MQTT_SHARE_SUBSCRIPTION_GROUP + '/4jggokgpepnvsb2uv4s40d59ov/motion001/' + constants.MEASURES_SUFIX);
    topics.push(
        constants.MQTT_SHARE_SUBSCRIPTION_GROUP + constants.MQTT_TOPIC_PROTOCOL + '/4jggokgpepnvsb2uv4s40d59ov/motion001/' + constants.MEASURES_SUFIX
    );
    topics.push(
        constants.MQTT_SHARE_SUBSCRIPTION_GROUP +
            '/4jggokgpepnvsb2uv4s40d59ov/motion001/' +
